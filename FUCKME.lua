--[[
	...
	Universal Aimbot Module by yap324 CC0 1.0 Universal (2023 - 2024)
...
local GetClosestPlayer = function()
	...
	if not Environment.Locked then
		RequiredDistance = Environment.FOVSettings.Enabled and Environment.FOVSettings.Radius or 50
